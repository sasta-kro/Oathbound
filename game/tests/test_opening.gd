...
func test_the_field_plays_the_opening_with_the_elder_by_the_well() -> void:
	...
	assert_eq(main.dialogue_panel.dialogue_text.text, DialoguePanel.first_page_of(GameOpening.WELCOME[0]))
	...
	assert_eq(main.dialogue_panel.dialogue_text.text, DialoguePanel.first_page_of(GameOpening.STARTER_EXPLAINED[0]))
	...
	assert_eq(main.dialogue_panel.dialogue_text.text, DialoguePanel.first_page_of(GameOpening.ASK))
	...
	assert_eq(main.dialogue_panel.dialogue_text.text, DialoguePanel.first_page_of(GameOpening.SEND_OFF[1]))
