...
const CAMP := [
	{
		...
		"stock": [&"item_healing_herb", &"item_full_heal_root", &"item_revive_potion", &"item_cleansing_water"],
	...
	},
	{
		...
		"stock": [&"item_binding_scroll", &"item_cleansing_water"],
...
const CHESTS := [
	{
		...
		"cell": Vector2i(20, 9),
		"items": [&"item_full_heal_root", &"item_healing_herb"],
		"counts": [2, 2],
